...
import static com.prestigeding.remoting.netty.TlsSystemConfig.TLS_CLIENT_AUTHSERVER;
import static com.prestigeding.remoting.netty.TlsSystemConfig.TLS_CLIENT_CERTPATH;
import static com.prestigeding.remoting.netty.TlsSystemConfig.TLS_CLIENT_KEYPASSWORD;
import static com.prestigeding.remoting.netty.TlsSystemConfig.TLS_CLIENT_KEYPATH;
import static com.prestigeding.remoting.netty.TlsSystemConfig.TLS_CLIENT_TRUSTCERTPATH;
import static com.prestigeding.remoting.netty.TlsSystemConfig.TLS_SERVER_AUTHCLIENT;
import static com.prestigeding.remoting.netty.TlsSystemConfig.TLS_SERVER_CERTPATH;
import static com.prestigeding.remoting.netty.TlsSystemConfig.TLS_SERVER_KEYPASSWORD;
import static com.prestigeding.remoting.netty.TlsSystemConfig.TLS_SERVER_KEYPATH;
import static com.prestigeding.remoting.netty.TlsSystemConfig.TLS_SERVER_NEED_CLIENT_AUTH;
import static com.prestigeding.remoting.netty.TlsSystemConfig.TLS_SERVER_TRUSTCERTPATH;
import static com.prestigeding.remoting.netty.TlsSystemConfig.TLS_TEST_MODE_ENABLE;
import static com.prestigeding.remoting.netty.TlsSystemConfig.tlsClientAuthServer;
import static com.prestigeding.remoting.netty.TlsSystemConfig.tlsClientCertPath;
import static com.prestigeding.remoting.netty.TlsSystemConfig.tlsClientKeyPassword;
import static com.prestigeding.remoting.netty.TlsSystemConfig.tlsClientKeyPath;
import static com.prestigeding.remoting.netty.TlsSystemConfig.tlsClientTrustCertPath;
import static com.prestigeding.remoting.netty.TlsSystemConfig.tlsServerAuthClient;
import static com.prestigeding.remoting.netty.TlsSystemConfig.tlsServerCertPath;
import static com.prestigeding.remoting.netty.TlsSystemConfig.tlsServerKeyPassword;
import static com.prestigeding.remoting.netty.TlsSystemConfig.tlsServerKeyPath;
import static com.prestigeding.remoting.netty.TlsSystemConfig.tlsServerNeedClientAuth;
import static com.prestigeding.remoting.netty.TlsSystemConfig.tlsServerTrustCertPath;
import static com.prestigeding.remoting.netty.TlsSystemConfig.tlsTestModeEnable;
...
public class TlsHelper {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(Constant.ROCKETMQ_REMOTING);
